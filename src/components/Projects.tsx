        ...
        >
          ...
          >
            {projects.map((project) => (
              <motion.div
                key={project.id}
                className="group relative bg-card/30 backdrop-blur-sm rounded-lg overflow-hidden border border-border/30 hover:border-primary/40 transition-all duration-500"
                ...
                <div className="p-6">
                  ...
                  {!project.isComingSoon && (
                    <motion.a
                      ...
                      className="inline-flex items-center gap-2 text-primary text-sm font-medium uppercase tracking-wider group/link"
                      whileHover={{ x: 5 }}
                    >
                      View Project
                  ...
                  {project.isComingSoon && (
                    <span className="text-muted-foreground/50 text-sm uppercase tracking-wider">
                      Coming Soon
                    </span>
                  )}
                </div>
